      ...
      <main className="w-full max-w-md px-6 py-12 relative z-10">
        ...
        <div className="glass-card rounded-lg p-8 shadow-2xl relative">
          <div className="mb-8">
            ...
            <p className="font-body text-on-surface-variant text-sm mt-1">Start your journey of infinite knowledge.</p>
          </div>
          
          <form className="space-y-6">
            <div>
              <label className="font-label text-[10px] uppercase tracking-widest text-on-surface-variant block mb-2 px-1">Full Name</label>
              <div className="relative group">
                ...
                <input className="w-full bg-surface-container-lowest border-none rounded-xl py-4 pl-12 pr-4 text-on-surface placeholder:text-outline outline-none focus:ring-2 focus:ring-secondary/20 transition-all font-body" placeholder="John Doe" type="text" />
              </div>
            </div>
            ...
            <div>
              <label className="font-label text-[10px] uppercase tracking-widest text-on-surface-variant block mb-2 px-1">Password</label>
              <div className="relative group">
                <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-outline text-xl transition-colors group-focus-within:text-secondary">
                  lock
                </span>
          ...
          <div className="mt-8 pt-8 border-t border-white/5 flex flex-col items-center gap-4">
            <p className="font-body text-on-surface-variant text-sm">Already have an account?</p>
            <Link to="/login" className="font-headline text-sm font-bold text-primary hover:text-primary-container transition-colors tracking-tight">Login Here</Link>
          </div>
        </div>
